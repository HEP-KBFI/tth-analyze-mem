...
Parameters_sm_tth_t2tavt_tbar2lvl_h2tata * Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_tth_t2tavt_tbar2lvl_h2tata * Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::getInstance()
{
  if (!instance)
    instance = new Parameters_sm_tth_t2tavt_tbar2lvl_h2tata();

  return instance; 
}

void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::setIndependentCouplings()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::setDependentCouplings()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::printIndependentParameters()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::printIndependentCouplings()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::printDependentParameters()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::printDependentCouplings()
{
