...
Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv * Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv * Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv();

  return instance; 
}

void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::setIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::setDependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::printIndependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::printIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::printDependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv::printDependentCouplings()
{
