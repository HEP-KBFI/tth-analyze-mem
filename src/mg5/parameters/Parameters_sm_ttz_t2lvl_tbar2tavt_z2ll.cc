...
#include "tthAnalysis/tthMEM/interface/mg5/parameters/Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll.h"
#include "tthAnalysis/tthMEM/interface/Logger.h"

#include <iomanip>

// Initialize static instance
Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll * Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll * Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll();

  return instance; 
}

void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::setIndependentCouplings()
{
...
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::setDependentCouplings()
{
...
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::printIndependentParameters()
{
...
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::printIndependentCouplings()
{
...
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::printDependentParameters()
{
...
void Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::printDependentCouplings()
{
