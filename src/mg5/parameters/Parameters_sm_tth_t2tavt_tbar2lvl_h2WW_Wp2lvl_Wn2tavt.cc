...
#include "tthAnalysis/tthMEM/interface/mg5/parameters/Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt.h"
#include "tthAnalysis/tthMEM/interface/Logger.h"

#include <iomanip>

// Initialize static instance
Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt * Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt * Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt();

  return instance; 
}

void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::setIndependentCouplings()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::setDependentCouplings()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::printIndependentParameters()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::printIndependentCouplings()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::printDependentParameters()
{
...
void Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt::printDependentCouplings()
{
