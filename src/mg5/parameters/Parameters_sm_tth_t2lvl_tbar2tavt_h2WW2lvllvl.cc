...
Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl * Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl * Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl();

  return instance; 
}

void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::setIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::setDependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::printIndependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::printIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::printDependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2tavt_h2WW2lvllvl::printDependentCouplings()
{
