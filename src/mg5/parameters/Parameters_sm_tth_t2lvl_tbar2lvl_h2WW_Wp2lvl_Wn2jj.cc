...
#include "tthAnalysis/tthMEM/interface/mg5/parameters/Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj.h"
#include "tthAnalysis/tthMEM/interface/Logger.h"

#include <iomanip>

// Initialize static instance
Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj * Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj * Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj();

  return instance; 
}

void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::setIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::setDependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::printIndependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::printIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::printDependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2lvl_Wn2jj::printDependentCouplings()
{
