...
#include "tthAnalysis/tthMEM/interface/mg5/parameters/Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl.h"
#include "tthAnalysis/tthMEM/interface/Logger.h"

#include <iomanip>

// Initialize static instance
Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl * Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::instance = nullptr;

// Function to get static instance - only one instance per program
Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl * Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::getInstance()
{
  if (! instance)
    instance = new Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl();

  return instance; 
}

void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::setIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::setDependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::printIndependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::printIndependentCouplings()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::printDependentParameters()
{
...
void Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2jj_Wn2lvl::printDependentCouplings()
{
