...
#include "tthAnalysis/tthMEM/interface/mg5/helamps/HelAmps_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2lvl_Wn2tavt.h"
#include "tthAnalysis/tthMEM/interface/Exception.h" // throw_line_ext()

using namespace std; 

namespace MG5_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2lvl_Wn2tavt
{
