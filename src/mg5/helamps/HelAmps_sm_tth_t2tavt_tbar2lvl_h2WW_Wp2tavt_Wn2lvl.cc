...
#include "tthAnalysis/tthMEM/interface/mg5/helamps/HelAmps_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2tavt_Wn2lvl.h"
#include "tthAnalysis/tthMEM/interface/Exception.h" // throw_line_ext()

using namespace std; 

namespace MG5_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2tavt_Wn2lvl
{
