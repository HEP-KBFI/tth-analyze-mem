...
using namespace MG5_sm_ttz_t2lvl_tbar2lvl_z2tata;
...
void mg5_ttz_t2lvl_tbar2lvl_z2tata::initProc(std::string param_card_name)
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_ttz_t2lvl_tbar2lvl_z2tata::getInstance();
...
void mg5_ttz_t2lvl_tbar2lvl_z2tata::sigmaKin()
{
...
double mg5_ttz_t2lvl_tbar2lvl_z2tata::sigmaHat()
{
...
//--------------------------------------------------------------------------
// Set Higgs width
void mg5_ttz_t2lvl_tbar2lvl_z2tata::setHiggsWidth(double __attribute__((unused)) higgsWidth)
{
...
double mg5_ttz_t2lvl_tbar2lvl_z2tata::matrix_1_gg_ttxz_t_bepve_tx_bxemvex_z_taptam()
{
  int i, j; 
  // Local variables
  //const int ngraphs = 8;
