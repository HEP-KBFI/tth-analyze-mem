...
#include "tthAnalysis/tthMEM/interface/mg5/me/mg5_ttz_t2lvl_tbar2lvl_z2ll_2.h"
...
void mg5_ttz_t2lvl_tbar2lvl_z2ll_2::initProc(string param_card_name)
{
...
void mg5_ttz_t2lvl_tbar2lvl_z2ll_2::sigmaKin()
{
...
double mg5_ttz_t2lvl_tbar2lvl_z2ll_2::sigmaHat()
{
...
void mg5_ttz_t2lvl_tbar2lvl_z2ll_2::calculate_wavefunctions(const int perm[], const int hel[])
{
