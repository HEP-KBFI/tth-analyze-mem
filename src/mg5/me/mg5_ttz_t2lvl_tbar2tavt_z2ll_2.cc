...
#include "tthAnalysis/tthMEM/interface/mg5/me/mg5_ttz_t2lvl_tbar2tavt_z2ll_2.h"
#include "tthAnalysis/tthMEM/interface/mg5/helamps/HelAmps_sm_ttz_t2lvl_tbar2tavt_z2ll.h"

using namespace MG5_sm_ttz_t2lvl_tbar2tavt_z2ll;
...
void mg5_ttz_t2lvl_tbar2tavt_z2ll_2::initProc(string param_card_name)
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll::getInstance();
...
void mg5_ttz_t2lvl_tbar2tavt_z2ll_2::sigmaKin()
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_tamvtx_z_mupmum(); 
...
double mg5_ttz_t2lvl_tbar2tavt_z2ll_2::sigmaHat()
{
...
void mg5_ttz_t2lvl_tbar2tavt_z2ll_2::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double mg5_ttz_t2lvl_tbar2tavt_z2ll_2::matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_tamvtx_z_mupmum()
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 
