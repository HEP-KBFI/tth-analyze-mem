...
#include "tthAnalysis/tthMEM/interface/mg5/me/mg5_tth_t2lvl_tbar2lvl_h2tata_qq.h"
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_uux_ttxh_t_bepve_tx_bxemvex_h_taptam(); 
        ...
        t[1] = matrix_1_uux_ttxh_t_bepve_tx_bxemvex_h_taptam(); 
        double tsum = 0; 
...
void mg5_tth_t2lvl_tbar2lvl_h2tata_qq::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[0], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
