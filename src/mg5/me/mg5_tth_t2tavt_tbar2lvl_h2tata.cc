...
#include "tthAnalysis/tthMEM/interface/mg5/me/mg5_tth_t2tavt_tbar2lvl_h2tata.h"
#include "tthAnalysis/tthMEM/interface/mg5/helamps/HelAmps_sm_tth_t2tavt_tbar2lvl_h2tata.h"

using namespace MG5_sm_tth_t2tavt_tbar2lvl_h2tata;
...
void mg5_tth_t2tavt_tbar2lvl_h2tata::initProc(string param_card_name)
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_tth_t2tavt_tbar2lvl_h2tata::getInstance();
...
void mg5_tth_t2tavt_tbar2lvl_h2tata::sigmaKin()
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_gg_ttxh_t_wpb_wp_tapvt_tx_wmbx_wm_emvex_h_taptam(); 
...
double mg5_tth_t2tavt_tbar2lvl_h2tata::sigmaHat()
{
...
void mg5_tth_t2tavt_tbar2lvl_h2tata::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double mg5_tth_t2tavt_tbar2lvl_h2tata::matrix_1_gg_ttxh_t_wpb_wp_tapvt_tx_wmbx_wm_emvex_h_taptam()
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 
