...
#include "tthAnalysis/tthMEM/interface/mg5/me/mg5_ttz_t2lvl_tbar2lvl_z2ll_4.h"
...
void mg5_ttz_t2lvl_tbar2lvl_z2ll_4::initProc(string param_card_name)
{
...
void mg5_ttz_t2lvl_tbar2lvl_z2ll_4::sigmaKin()
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_emvex_z_epem(); 
...
double mg5_ttz_t2lvl_tbar2lvl_z2ll_4::sigmaHat()
{
...
void mg5_ttz_t2lvl_tbar2lvl_z2ll_4::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double mg5_ttz_t2lvl_tbar2lvl_z2ll_4::matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_emvex_z_epem()
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 
