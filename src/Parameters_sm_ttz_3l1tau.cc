...
#include <iostream> 
#include <iomanip> 
#include "tthAnalysis/tthMEM/interface/Parameters_sm_ttz_3l1tau.h"
#include "tthAnalysis/tthMEM/interface/Logger.h"

// Initialize static instance
Parameters_sm_ttz_3l1tau * Parameters_sm_ttz_3l1tau::instance = 0;

// Function to get static instance - only one instance per program
Parameters_sm_ttz_3l1tau * Parameters_sm_ttz_3l1tau::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_ttz_3l1tau();

  return instance; 
}

void Parameters_sm_ttz_3l1tau::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ttz_3l1tau::setIndependentCouplings()
{
...
void Parameters_sm_ttz_3l1tau::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_ttz_3l1tau::setDependentCouplings()
{
...
void Parameters_sm_ttz_3l1tau::printIndependentParameters()
{
...
void Parameters_sm_ttz_3l1tau::printIndependentCouplings()
{
  LOGDBG <<  "sm model couplings independent of event kinematics:";
  LOGDBG << setw(20) <<  "GC_50 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_50;
  LOGDBG << setw(20) <<  "GC_51 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_51;
  LOGDBG << setw(20) <<  "GC_58 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_58;
  LOGDBG << setw(20) <<  "GC_59 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_59;
  LOGDBG << setw(20) <<  "GC_100 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_100;
}
void Parameters_sm_ttz_3l1tau::printDependentParameters()
{
...
void Parameters_sm_ttz_3l1tau::printDependentCouplings()
{
