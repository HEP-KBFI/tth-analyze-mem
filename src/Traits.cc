#include "tthAnalysis/tthMEM/interface/Traits.h"

#include <Rtypes.h> // *_t

#define DEFINE_TYPE_TRAIT(type,name) template <> __attribute__ ((unused)) const char * tthMEM::_Traits<type>::TYPE_NAME = name
