...
#ifndef Parameters_sm_ttz_3l1tau_H
#define Parameters_sm_ttz_3l1tau_H
...
class Parameters_sm_ttz_3l1tau
{
  public:

    static Parameters_sm_ttz_3l1tau * getInstance();
  ...
  private:
    static Parameters_sm_ttz_3l1tau * instance;
}; 

#endif  // Parameters_sm_ttz_3l1tau_H
