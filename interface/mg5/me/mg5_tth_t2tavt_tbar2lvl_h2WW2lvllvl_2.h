...
#ifndef MG5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_2_H
#define MG5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_2_H
...
class mg5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_2
{
  public:

    // Constructor.
    mg5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_2()
    {
    ...
    // Destructor.
    virtual ~mg5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_2()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > ta+ vt b mu- vm~ b~ e+ ve e- ve~ (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxh_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx_h_wpwm_wp_epve_wm_emv_1();
    ...
    Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl * pars;
...
#endif  // MG5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_2_H
