...
#ifndef mg5_tth_t2lvl_tbar2tavt_h2WW2lvllvl_1_h
#define mg5_tth_t2lvl_tbar2tavt_h2WW2lvllvl_1_h
...
class mg5_tth_t2lvl_tbar2tavt_h2WW2lvllvl_1
{
  public:

    // Constructor.
    mg5_tth_t2lvl_tbar2tavt_h2WW2lvllvl_1()
    {
    ...
    // Destructor.
    virtual ~mg5_tth_t2lvl_tbar2tavt_h2WW2lvllvl_1()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b ta- vt~ b~ e+ ve e- ve~ (sm)";
    }
  ...
  private:
    ...
    double matrix_1_gg_ttxh_t_wpb_wp_epve_tx_wmbx_wm_tamvtx_h_wpwm_wp_epve_wm_emve_1(); 
...
#endif  // mg5_tth_t2lvl_tbar2tavt_h2WW2lvllvl_1_h
