...
#ifndef MG5_ttz_t2tavt_tbar2lvl_z2tata_H
#define MG5_ttz_t2tavt_tbar2lvl_z2tata_H
...
class mg5_ttz_t2tavt_tbar2lvl_z2tata
{
  public:

    // Constructor.
    mg5_ttz_t2tavt_tbar2lvl_z2tata()
    {
    ...
    // Destructor.
    virtual ~mg5_ttz_t2tavt_tbar2lvl_z2tata()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
  ...
  private:
    ...
    double
    matrix_1_gg_ttxz_t_wpb_wp_tapvt_tx_wmbx_wm_emvex_z_taptam();
    ...
    Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata * pars;
...
#endif  // MG5_ttz_t2tavt_tbar2lvl_z2tata_H
