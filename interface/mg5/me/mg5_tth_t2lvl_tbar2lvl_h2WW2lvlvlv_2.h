...
#ifndef MG5_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_2_H
#define MG5_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_2_H
...
class mg5_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_2
{
  public:

    // Constructor.
    mg5_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_2()
    {
    ...
    // Destructor.
    virtual ~mg5_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_2()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b mu- vm~ b~ e+ ve e- ve~ (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxh_t_wpb_wp_epve_tx_wmbx_wm_mumvmx_h_wpwm_wp_epve_wm_emve_1();
...
#endif  // MG5_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_2_H
