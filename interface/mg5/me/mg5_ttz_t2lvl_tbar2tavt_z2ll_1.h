...
#ifndef MG5_ttz_t2lvl_tbar2tavt_z2ll_1_H
#define MG5_ttz_t2lvl_tbar2tavt_z2ll_1_H
...
class mg5_ttz_t2lvl_tbar2tavt_z2ll_1
{
  public:

    // Constructor.
    mg5_ttz_t2lvl_tbar2tavt_z2ll_1()
    {
    ...
    // Destructor.
    virtual ~mg5_ttz_t2lvl_tbar2tavt_z2ll_1()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b ta- vt~ b~ e+ e- (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_tamvtx_z_epem();
...
#endif  // MG5_ttz_t2lvl_tbar2tavt_z2ll_1_H
