...
#ifndef MG5_ttz_t2tavt_tbar2lvl_z2ll_1_H
#define MG5_ttz_t2tavt_tbar2lvl_z2ll_1_H
...
class mg5_ttz_t2tavt_tbar2lvl_z2ll_1
{
  public:

    // Constructor.
    mg5_ttz_t2tavt_tbar2lvl_z2ll_1()
    {
    ...
    // Destructor.
    virtual ~mg5_ttz_t2tavt_tbar2lvl_z2ll_1()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > ta+ vt b e- ve~ b~ e+ e- (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxz_t_wpb_wp_tapvt_tx_wmbx_wm_emvex_z_epem();
...
#endif  // MG5_ttz_t2tavt_tbar2lvl_z2ll_1_H
