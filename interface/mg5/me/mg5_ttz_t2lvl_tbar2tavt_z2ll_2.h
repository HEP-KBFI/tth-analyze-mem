...
#ifndef MG5_ttz_t2lvl_tbar2tavt_z2ll_2_H
#define MG5_ttz_t2lvl_tbar2tavt_z2ll_2_H
...
class mg5_ttz_t2lvl_tbar2tavt_z2ll_2
{
  public:

    // Constructor.
    mg5_ttz_t2lvl_tbar2tavt_z2ll_2()
    {
    ...
    // Destructor.
    virtual ~mg5_ttz_t2lvl_tbar2tavt_z2ll_2()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b ta- vt~ b~ mu+ mu- (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_tamvtx_z_mupmum();
    ...
    Parameters_sm_ttz_t2lvl_tbar2tavt_z2ll * pars;
...
#endif  // MG5_ttz_t2lvl_tbar2tavt_z2ll_2_H
