...
#ifndef MG5_ttz_t2lvl_tbar2lvl_z2ll_2_H
#define MG5_ttz_t2lvl_tbar2lvl_z2ll_2_H
...
class mg5_ttz_t2lvl_tbar2lvl_z2ll_2
{
  public:
    ...
    // Destructor.
    virtual ~mg5_ttz_t2lvl_tbar2lvl_z2ll_2()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
...
#endif  // MG5_ttz_t2lvl_tbar2lvl_z2ll_2_H
