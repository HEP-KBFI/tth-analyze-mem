...
#ifndef MG5_ttz_t2lvl_tbar2lvl_z2ll_3_H
#define MG5_ttz_t2lvl_tbar2lvl_z2ll_3_H
...
class mg5_ttz_t2lvl_tbar2lvl_z2ll_3
{
  public:

    // Constructor.
    mg5_ttz_t2lvl_tbar2lvl_z2ll_3()
    {
    ...
    // Destructor.
    virtual ~mg5_ttz_t2lvl_tbar2lvl_z2ll_3()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b e- ve~ b~ mu+ mu- (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_emvex_z_mupmum();
    ...
    Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll * pars;
...
#endif  // MG5_ttz_t2lvl_tbar2lvl_z2ll_3_H
