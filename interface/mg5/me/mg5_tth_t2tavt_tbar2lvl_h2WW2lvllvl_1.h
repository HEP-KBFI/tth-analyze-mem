...
class mg5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_1
{
  public:

    // Constructor.
    mg5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_1()
    {
    ...
    // Destructor.
    virtual ~mg5_tth_t2tavt_tbar2lvl_h2WW2lvllvl_1()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > ta+ vt b e- ve~ b~ e+ ve e- ve~ (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxh_t_wpb_wp_tapvt_tx_wmbx_wm_emvex_h_wpwm_wp_epve_wm_emve_1();
