...
#ifndef MG5_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2_H
#define MG5_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2_H
...
class mg5_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2
{
  public:

    // Constructor.
    mg5_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2()
    {
    ...
    // Destructor.
    virtual ~mg5_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b mu- vm~ b~ ta+ vt e- ve~ (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxh_t_wpb_wp_epve_tx_wmbx_wm_mumvmx_h_wpwm_wp_tapvt_wm_emv_1();
    ...
    Parameters_sm_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl * pars;
...
#endif  // MG5_tth_t2lvl_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2_H
