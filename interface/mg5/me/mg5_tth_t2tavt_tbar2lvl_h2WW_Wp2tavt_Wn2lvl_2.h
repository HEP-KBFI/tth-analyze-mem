...
#ifndef MG5_tth_t2tavt_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2_H
#define MG5_tth_t2tavt_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2_H
...
class mg5_tth_t2tavt_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2
{
  public:
    ...
    name() const
    {
      return "g g > ta+ vt b mu- vm~ b~ ta+ vt e- ve~ (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxh_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx_h_wpwm_wp_tapvt_wm_em_1();
...
#endif  // MG5_tth_t2tavt_tbar2lvl_h2WW_Wp2tavt_Wn2lvl_2_H
