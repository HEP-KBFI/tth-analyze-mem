...
#ifndef MG5_ttz_t2lvl_tbar2tavt_z2tata_H
#define MG5_ttz_t2lvl_tbar2tavt_z2tata_H
...
class mg5_ttz_t2lvl_tbar2tavt_z2tata
{
  public:

    // Constructor.
    mg5_ttz_t2lvl_tbar2tavt_z2tata()
    {
    ...
    // Destructor.
    virtual ~mg5_ttz_t2lvl_tbar2tavt_z2tata()
    {
      for(std::size_t i = 0; i < nprocesses; ++i)
        if(jamp2[i])
        {
    ...
    name() const
    {
      return "g g > e+ ve b ta- vt~ b~ ta+ ta- (sm)";
    }
  ...
  private:
    ...
    double
    matrix_1_gg_ttxz_t_wpb_wp_epve_tx_wmbx_wm_tamvtx_z_taptam();
    ...
    Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata * pars;
...
#endif  // MG5_ttz_t2lvl_tbar2tavt_z2tata_H
