...
#ifndef Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt_H
#define Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt
{
  public:

    static Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt * getInstance();
  ...
  private:
    static Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt * instance;
}; 

#endif  // Parameters_sm_tth_t2tavt_tbar2lvl_h2WW_Wp2lvl_Wn2tavt_H
