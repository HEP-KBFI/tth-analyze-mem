...
#ifndef Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_H
#define Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv
{
  public:

    static Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv * getInstance();
  ...
  private:
    static Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv * instance;
}; 

#endif  // Parameters_sm_tth_t2lvl_tbar2lvl_h2WW2lvlvlv_H
