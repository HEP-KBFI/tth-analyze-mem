...
#ifndef Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll_H
#define Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll
{
  public:

    static Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll * getInstance();
  ...
  private:
    static Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll * instance;
}; 

#endif  // Parameters_sm_ttz_t2lvl_tbar2lvl_z2ll_H
