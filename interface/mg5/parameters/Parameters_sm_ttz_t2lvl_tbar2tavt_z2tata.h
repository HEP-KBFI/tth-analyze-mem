...
#ifndef Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata_H
#define Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata
{
  public:

    static Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata * getInstance();
  ...
  private:
    static Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata * instance;
}; 

#endif  // Parameters_sm_ttz_t2lvl_tbar2tavt_z2tata_H
