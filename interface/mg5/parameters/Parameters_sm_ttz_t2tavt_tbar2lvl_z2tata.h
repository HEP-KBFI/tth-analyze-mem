...
#ifndef Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata_H
#define Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata
{
  public:

    static Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata * getInstance();
    ...
    std::complex<double> GC_50, GC_51, GC_58, GC_59, GC_100; 
  ...
  private:
    static Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata * instance;
}; 

#endif  // Parameters_sm_ttz_t2tavt_tbar2lvl_z2tata_H
