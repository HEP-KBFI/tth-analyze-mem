...
#ifndef Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl_H
#define Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl
{
  public:

    static Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl * getInstance();
  ...
  private:
    static Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl * instance;
}; 

#endif  // Parameters_sm_tth_t2tavt_tbar2lvl_h2WW2lvllvl_H
