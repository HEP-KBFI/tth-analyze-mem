...
#ifndef Parameters_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2tavt_Wn2lvl_H
#define Parameters_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2tavt_Wn2lvl_H

#include "tthAnalysis/tthMEM/interface/mg5/read_slha.h"

#include <complex>

class Parameters_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2tavt_Wn2lvl
{
  public:

    static Parameters_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2tavt_Wn2lvl * getInstance();
  ...
  private:
    static Parameters_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2tavt_Wn2lvl * instance;
}; 

#endif  // Parameters_sm_tth_t2lvl_tbar2tavt_h2WW_Wp2tavt_Wn2lvl_H
